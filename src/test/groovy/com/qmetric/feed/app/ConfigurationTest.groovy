...
class ConfigurationTest extends Specification {
    ...
    def "should parse full configuration"()
    {
        ...
        fullConfig.dataSourceConfiguration == new DataSourceConfiguration("com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/feed", "user", "password")
    }
    ...
    def "should parse minimal configuration"()
    {
        ...
        minimalConfig.dataSourceConfiguration == new DataSourceConfiguration("com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/feed", "user", "password")
    }
}
