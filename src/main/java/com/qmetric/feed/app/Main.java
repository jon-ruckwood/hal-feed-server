...
public class Main
{
    ...
    private void configureSpark(final Feed feed, final FeedRepresentationFactory<Representation> feedResponseFactory)
    {
        ...
        postPublishToFeedRoute(contextPath, feed, feedResponseFactory);

        get(new MetricsRoute(metricRegistry));
    }

    private void postPublishToFeedRoute(final String contextPath, final Feed feed, final FeedRepresentationFactory<Representation> feedResponseFactory)
    {
        ...
        decorate(publishToFeedRoute, contextPath);
    }

    private void decorate(final PublishToFeedRoute publishToFeedRoute, final String contextPath)
    {
